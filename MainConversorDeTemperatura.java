...
public class MainConversorDeTemperatura {
    public static void main(String[] args) {
        ...
        Double fator1 = (double)9 / 5; int fator2 = 32;
        ...
        if (unid1 == 1 && unid2 == 2){
            ...
            System.out.println("Não é possível realizar a conversão, reinicie a aplicação!");
        }


        try{
            System.out.println("executou o trai");
        }catch(java.util.InputMismatchException exception){
            System.out.println("executou o gato em ingles");
        }

        System.out.println("esse texto será depois da execao");
